...
!
!  Last Modified: Wed  9 Oct 11:16:37 2019
!
! ---
...
!  begin subroutine
      ...
      if ( debug ) write(*,*) 'Entering MD_step()'

!  now perform appropriate dynamics step (second part)

      select case( simulation % dyntype )

      case( 0 )  ! this is the standard velocity-verlet NVE (microcanonical )dynamics

          call velocityVerlet_B( state )
      ...
      case( 1 )  ! this case is NVT dynamics implemented via the Nosé-Poincaré thermostat as
          ...
          ! call NosePoincare_B( state )
          call NosePoincareChain_B( state )
